...
int mongoc_auth_info(char *supi, ogs_dbi_auth_info_t *auth_info)
{
    int rv = OGS_OK;
...
int mongoc_update_mme(char *supi, char *mme_host, char *mme_realm,
    bool purge_flag)
{
    int rv = OGS_OK;
    bson_t *query = NULL;
...
int mongoc_subscription_data(char *supi,
